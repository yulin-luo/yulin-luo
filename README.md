...
<p align="center">
  <strong>Ph.D. candidate @ School of Computer Science, Peking University</strong><br>
...
<p align="center">
  ...
  <img alt="Goal-aligned Evaluation" src="https://img.shields.io/badge/Goal--aligned-Evaluation-F66A0A?style=flat-square">
...
<div style="margin-top:10px; font-size:.95rem; line-height:1.75;">
  ...
  <p>
    ...
    I work on generalizable embodied foundation models, goal-aligned robot benchmarks,
    and evaluation-driven model-data co-evolution.
  </p>
</div>

<table>
  <tr>
    <td width="33%"><strong>🤖 Model</strong><br>Designing architectures and learning algorithms for embodied foundation models that generalize across objects, skills, embodiments, scenes, and tasks.</td>
    <td width="33%"><strong>🧭 Evaluation</strong><br>Building goal-aligned robot benchmarks that diagnose model capabilities under realistic open-world conditions.</td>
    <td width="33%"><strong>🔁 Co-evolution</strong><br>Turning diagnosed gaps into model and data redesign, then using improved systems to define the next evaluation cycle.</td>
  </tr>
</table>
...
* **[ACM MM 26, CCF-A]** DeepVision-VLA: Enhancing Vision Foundation Representations for Vision-Language-Action Models, [Webpage](https://deepvision-vla.github.io/) / [arXiv](https://arxiv.org/abs/2603.15618)
...
* **RandStainNA**: stain-agnostic histology augmentation and normalization for robust medical image analysis. [Code](https://github.com/yiqings/RandStainNA) / [arXiv](https://arxiv.org/abs/2206.12694) <img alt="GitHub repo stars" src="https://img.shields.io/github/stars/yiqings/RandStainNA?style=social">
